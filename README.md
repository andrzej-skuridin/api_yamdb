...
Учебный групповой проект курса Backend-разработчик на Python от Яндекс. API-сервис, позволяющий оставлять ревью к произведениям искусства (фильмы, книги и т.д.) и комментарии к ним.
